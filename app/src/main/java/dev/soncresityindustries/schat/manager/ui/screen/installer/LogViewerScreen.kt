package dev.soncresityindustries.schat.manager.ui.screen.installer
...
import dev.soncresityindustries.schat.manager.ui.widgets.installer.LogLine
import dev.soncresityindustries.schat.manager.utils.DimenUtils
import dev.soncresityindustries.schat.manager.utils.rememberFileSaveLauncher
import dev.soncresityindustries.schat.manager.utils.thenIf
    ...
    private fun Toolbar(
        ...
        TopAppBar(
            ...
            actions = {
                ...
                IconButton(onClick = { saveFile.launch("SChat-Manager-${System.currentTimeMillis()}.log") }) {
                    Icon(
