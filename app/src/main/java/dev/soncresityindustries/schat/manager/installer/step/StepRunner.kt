package dev.soncresityindustries.schat.manager.installer.step
...
import dev.soncresityindustries.schat.manager.installer.step.download.DownloadBaseStep
import dev.soncresityindustries.schat.manager.installer.step.download.DownloadLangStep
import dev.soncresityindustries.schat.manager.installer.step.download.DownloadLibsStep
import dev.soncresityindustries.schat.manager.installer.step.download.DownloadResourcesStep
import dev.soncresityindustries.schat.manager.installer.step.download.DownloadSChatStep
import dev.soncresityindustries.schat.manager.installer.step.installing.InstallStep
import dev.soncresityindustries.schat.manager.installer.step.patching.AddVendettaStep
import dev.soncresityindustries.schat.manager.installer.step.patching.PatchManifestsStep
import dev.soncresityindustries.schat.manager.installer.step.patching.PresignApksStep
import dev.soncresityindustries.schat.manager.installer.step.patching.ReplaceIconStep
import dev.soncresityindustries.schat.manager.installer.util.LogEntry
import dev.soncresityindustries.schat.manager.installer.util.Logger
...
class StepRunner(
    ...
    private val debugInfo = """
            SChat Manager v${BuildConfig.VERSION_NAME}
            ...
            Adding SChat to Discord v$discordVersion
    ...
    val steps: ImmutableList<Step> = buildList {
        ...
        add(DownloadSChatStep(patchedDir))
