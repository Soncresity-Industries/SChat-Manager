package dev.soncresityindustries.schat.manager.ui.viewmodel.settings
...
import dev.soncresityindustries.schat.manager.domain.manager.UpdateCheckerDuration
import dev.soncresityindustries.schat.manager.installer.shizuku.ShizukuPermissions
import dev.soncresityindustries.schat.manager.updatechecker.worker.UpdateWorker
...
class AdvancedSettingsViewModel(
    ...
    fun updateCheckerDuration(updateCheckerDuration: UpdateCheckerDuration) {
        ...
        when (updateCheckerDuration) {
            UpdateCheckerDuration.DISABLED -> wm.cancelUniqueWork("dev.soncresityindustries.schat.manager.UPDATE_CHECK")
            else -> wm.enqueueUniquePeriodicWork(
                "dev.soncresityindustries.schat.manager.UPDATE_CHECK",
