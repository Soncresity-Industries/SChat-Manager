package dev.soncresityindustries.schat.manager.ui.widgets.libraries
...
import dev.soncresityindustries.schat.manager.ui.components.Label
    ...
    Column(
        ...
        FlowRow(
            ...
            if (library.developers.isNotEmpty()) {
                Label(
                    text = library.developers.joinToString { it.name.toString() },
