package dev.soncresityindustries.schat.manager.domain.manager
...
import dev.soncresityindustries.schat.manager.domain.manager.base.BasePreferenceManager
...
class PreferenceManager(context: Context) :
    ...
    val DEFAULT_MODULE_LOCATION =
        ...
        ).resolve("SChatManager").also { it.mkdirs() }).resolve("xposed.apk")

    var packageName by stringPreference("package_name", "dev.soncresityindustries.schat.app")

    var appName by stringPreference("app_name", "SChat")
