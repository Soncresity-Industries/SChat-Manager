...
import dev.soncresityindustries.schat.manager.installer.util.AxmlUtil.getMainAxmlChunk
import dev.soncresityindustries.schat.manager.utils.find
import java.io.File
    ...
    fun patchAdaptiveIcon(
        ...
        if (monochromeIcon != null) {
            ...
            // `<monochrome android:drawable="@drawable/xyz"></monochrome>
                ...
                val namespaceIdx =
                    xmlChunk.stringPool.indexOf("http://schemas.android.com/apk/res/android")
