...
fun EndOfLifeDialog(onDismiss: () -> Unit) {
    ...
    AlertDialog(
        ...
        text = {
            Text(
                text = "SChat is no longer maintained. Versions have been set to the latest ones supported by SChat. Please consider switching to an alternative client mod."
            )
        },
        icon = {
